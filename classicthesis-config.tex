...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{ifthen}
\newboolean{printout} % this disables colorlinks and makes some tikzpictures grayscale (except the one oddball ignoring the setting)
\setboolean{printout}{true}
\newcommand*{\makegrayinprint}{
   \ifthenelse{\boolean{printout}}
   {\selectcolormodel{gray}}{\relax}
}
...
% for programmablaufplans
\tikzstyle{typewriter} = [font=\small\ttfamily]
\tikzstyle{decision} = [diamond, draw, typewriter,
                        text width=4.5em, text badly centered, inner sep=0pt]
\tikzstyle{block}    = [rectangle, rounded corners=5pt, draw, typewriter,
...
% ********************************************************************
   \ifthenelse{\boolean{printout}}
   {\PassOptionsToPackage{colorlinks}{hyperref}}{\relax}
\hypersetup{%
