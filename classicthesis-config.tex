...
\usetikzlibrary{shapes,backgrounds,arrows.meta,calc,intersections,positioning,spy} % funnily, putting this into the tex file for pinhole.tex has no effect. wtf
