...
\usetikzlibrary{automata,shapes,backgrounds,arrows.meta,calc,intersections,positioning,spy} % funnily, putting this into the tex file for pinhole.tex has no effect. wtf
...
\tikzstyle{decision} = [diamond, draw, text=white, fill=RoyalBlue, typewriter,
