...
\begin{figure}[h]
   {\centering      
      ...
      \caption{Schematic representation of the Train Station data set. Lengths and angles are not
      precise.}
...
The decrease in ratio closely correlates with the the decrease in distance which
...
The correlation is higher for KAZE
...
would tell the user that they need to move disporoportionally far compared to
...
Generally, it can be concluded that on this data set, KAZE features are an
...
\begin{figure}[h]
   ...
   \end{subfigure}
   \caption{Train Station data set: Evolution of the distance ratio between images}
...
for KAZE and SIFT features, respectively. Rotations about the optical an X axes
...
\begin{figure}[h]
   ...
   \end{subfigure}
   \caption{Train Station data set: Angles of rotation relative to reference with
...
\begin{figure}[h]
   ...
   \end{subfigure}
   \caption{Train Station data set: Angles of rotation relative to reference with SIFT features}
...
\begin{figure}[h]
   ...
   \end{subfigure}
   \caption{Train Station data set: Angular difference between actually necessary translation and algorithmic estimate}
...
% Since the distance to the reference increases with image index, the distance
...
limits of this simple approach at scale estimation.
...
\begin{figure}[h]
   ...
   \quad\begin{subfigure}{.5\linewidth}
      ...
      \caption{SIFT features (logarithmic $Y$-axis)}
      \label{fig:manor_SIFT_dist_ratio}
   \end{subfigure}
   \caption{Manor data set: Evolution of the distance ratio between images}
...
\begin{figure}[h]
   ...
   \begin{subfigure}{\linewidth}
      ...
      \caption{$s=4$}
   \end{subfigure}
   \caption{Manor data set: Angles of rotation relative to reference with
   KAZE features}
\end{figure}
...
\begin{figure}[h]
   ...
   \end{subfigure}
   \caption{Manor data set: Angular difference between actually necessary translation and estimate}
