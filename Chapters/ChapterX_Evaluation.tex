...
\begin{figure}[h]
   ...
   \begin{subfigure}{.5\linewidth}
      ...
      \caption{SIFT features (logarithmic scale)}
...
reproduced with $s=2$, but strangely less accurately on full resolution (note
the logarithmic scale). For the smallest scale, the estimate degenerates
strongly.
