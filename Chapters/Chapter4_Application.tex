...
This view controller displays a scrollable and pannable view and a button to
load a photograph into it. The photo is picked from the user's photo album.
...
version and can be used for other kinds of preferences.
