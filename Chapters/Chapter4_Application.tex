...
(\raisebox{-3pt}{\includegraphics[width=1em]{gfx/settings_icon.png}}, see below) as well as a
button to start the rephotograph
(\raisebox{-1pt}{\includegraphics[width=1em]{gfx/cam_icon.png}}).
...
added, the lightweight Category concept is employed. A Category on a class adds
methods or properties to that class and can also override functionality. The
header file declaring the category can be included by all clients that wish to
make use of the modified or added behaviour, and left out by all others. This
way, no unnecessarily large class hierarchy is created.
