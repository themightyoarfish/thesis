...
\subsection{Objective-C \& C++ --- The PIMPL pattern}
...
\nofloat{gfx/rephoto_manager.PNG}{\code{RephotoManager} in \code{HAS\_SECOND\_FRAME} state}
...
\subsection{Parallel Computation Of Necessary Translation}
