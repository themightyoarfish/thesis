...
work for movement in only one principal direction.

One possible approach to circumvent this issue could be to scale each summand
before the addition with the inverse of their respective world scales. As the
...
will be attempted in future work.
